            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 6),
                  Text('Discover products for your next purchase.'),
                ],
              ),
            ),
          ),
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            child: ListView(
              ...
              children: [
                for (final value in ['All', 'Electronics', 'Fashion', 'Home'])
                  Padding(
        ...
        SliverPadding(
          ...
          sliver: SliverGrid(
            delegate: SliverChildBuilderDelegate(
              (_, index) => _ProductCard(product: products[index]),
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: Icon(_icon(product.category), size: 70),
              ),
            ),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(12, 3, 7, 7),
              child: Row(
                children: [
                  Text(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(_icon(product.category), size: 90),
          ),
          ...
          (line) => Card(
            child: ListTile(
              leading: CircleAvatar(
                child: Icon(_icon(line.product.category)),
              ),
              title: Text(line.product.name),
              subtitle: Text(
                '₹${line.product.price.toStringAsFixed(0)} × ${line.quantity}',
              ),
              trailing: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
    ...
    return const Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Ask for product recommendations, comparisons, or budget-friendly options.',
          ),
          SizedBox(height: 16),
          TextField(
            decoration: InputDecoration(
